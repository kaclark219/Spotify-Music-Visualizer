export type GenreColors = { [genre: string]: string[] };
...
export const genreColors: GenreColors = {
  ...
  "emo": ["#842121", "#4682B4", "#a9a9a9"], // Dark Red, Steel Blue, Dark Gray
  "punk rock": ["#ff1493", "#000000", "#ffff00"], // Deep Pink, Black, Yellow
  ...
  "dream pop": ["#ff6347", "#f0e68c", "#32cd32"], // Tomato, Khaki, Lime Green
  "lo-fi": ["#8b4513", "#d2b48c", "#deb887"], // Saddle Brown, Tan, Burly Wood
  "hyperpop": ["#ff77ff", "#00ff00", "#00ffff"], // Pastel Pink, Neon Green, Electric Blue
  "k-rap": ["#ff7f00", "#4b0082", "#808080"], // Bright Orange, Indigo, Gray
  "rap": ["#ff6347", "#39FF14", "#f0e68c"], // Tomato, Neon Green, Khaki
  "bedroom pop": ["#ffb300", "#8b4513", "#ff69b4"], // Warm Yellow, Saddle Brown, Light Pink
